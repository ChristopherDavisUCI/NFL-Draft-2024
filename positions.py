...
default_authors = ["Andy Molitor", "Daniel Jeremiah", "Peter Schrager", "Charlie Campbell", "Dane Brugler", 
                   "Matthew Freedman",    "Danny Kelly", "Benjamin Solak",
